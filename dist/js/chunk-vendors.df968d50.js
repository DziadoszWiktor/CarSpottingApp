 ...
 * limitations under the License.
 */
class l extends i.ZR{constructor(e,t){super(h(e),`Firebase Storage: ${t} (${h(e)})`),this.customData={serverResponse:null},this._baseMessage=this.message,Object.setPrototypeOf(this,l.prototype)}_codeEquals(e){return h(e)===this.code}get serverResponse(){return this.customData.serverResponse}set serverResponse(e){this.customData.serverResponse=e,this.customData.serverResponse?this.message=`${this._baseMessage}\n${this.customData.serverResponse}`:this.message=this._baseMessage}}function h(e){return"storage/"+e}function d(){const e="An unknown error occurred, please check the error payload for server response.";return new l("unknown",e)}function f(e){return new l("quota-exceeded","Quota for bucket '"+e+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function p(){const e="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new l("unauthenticated",e)}function m(){return new l("unauthorized-app","This app does not have permission to access Firebase Storage on this project.")}function g(e){return new l("unauthorized","User does not have permission to access '"+e+"'.")}function y(){return new l("retry-limit-exceeded","Max retry time for operation exceeded, please try again.")}function v(){return new l("canceled","User canceled the upload/download.")}function w(e){return new l("invalid-url","Invalid URL '"+e+"'.")}function _(e){return new l("invalid-default-bucket","Invalid default bucket '"+e+"'.")}function b(){return new l("no-default-bucket","No default bucket found. Did you set the '"+a+"' property when initializing the app?")}function I(){return new l("cannot-slice-blob","Cannot slice blob for upload. Please retry the upload.")}function E(e){return new l("invalid-argument",e)}function T(){return new l("app-deleted","The Firebase app was deleted.")}function S(e){return new l("invalid-root-operation","The operation '"+e+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function k(e,t){return new l("invalid-format","String does not match format '"+e+"': "+t)}function A(e){throw new l("internal-error","Internal error: "+e)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function D(e){return void 0!==e}function O(e){return"object"===typeof e&&!Array.isArray(e)}function P(e){return"string"===typeof e||e instanceof String}function L(e){return M()&&e instanceof Blob}function M(){return"undefined"!==typeof Blob}function F(e,t,n,r){if(r<t)throw E(`Invalid value for '${e}'. Expected ${t} or greater.`);if(r>n)throw E(`Invalid value for '${e}'. Expected ${n} or less.`)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function V(e,t,n){let r=t;return null==n&&(r=`https://${t}`),`${n}://${r}/v0${e}`}function U(e){const t=encodeURIComponent;let n="?";for(const r in e)if(e.hasOwnProperty(r)){const i=t(r)+"="+t(e[r]);n=n+i+"&"}return n=n.slice(0,-1),n}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class B{constructor(e,t,n,r,i,s,o,a,c,u,l){this.url_=e,this.method_=t,this.headers_=n,this.body_=r,this.successCodes_=i,this.additionalRetryCodes_=s,this.callback_=o,this.errorCallback_=a,this.timeout_=c,this.progressCallback_=u,this.connectionFactory_=l,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise(((e,t)=>{this.resolve_=e,this.reject_=t,this.start_()}))}start_(){const e=(e,t)=>{if(t)return void e(!1,new q(!1,null,!0));const n=this.connectionFactory_();this.pendingConnection_=n;const r=e=>{const t=e.loaded,n=e.lengthComputable?e.total:-1;null!==this.progressCallback_&&this.progressCallback_(t,n)};null!==this.progressCallback_&&n.addUploadProgressListener(r),n.send(this.url_,this.method_,this.body_,this.headers_).then((()=>{null!==this.progressCallback_&&n.removeUploadProgressListener(r),this.pendingConnection_=null;const t=n.getErrorCode()===j.NO_ERROR,i=n.getStatus();if(!t||this.isRetryStatusCode_(i)){const t=n.getErrorCode()===j.ABORT;return void e(!1,new q(!1,null,t))}const s=-1!==this.successCodes_.indexOf(i);e(!0,new q(s,n))}))},t=(e,t)=>{const n=this.resolve_,r=this.reject_,i=t.connection;if(t.wasSuccessCode)try{const e=this.callback_(i,i.getResponse());D(e)?n(e):n()}catch(s){r(s)}else if(null!==i){const e=d();e.serverResponse=i.getErrorText(),this.errorCallback_?r(this.errorCallback_(i,e)):r(e)}else if(t.canceled){const e=this.appDelete_?T():v();r(e)}else{const e=y();r(e)}};this.canceled_?t(!1,new q(!1,null,!0)):this.backoffId_=R(e,t,this.timeout_)}getPromise(){return this.promise_}cancel(e){this.canceled_=!0,this.appDelete_=e||!1,null!==this.backoffId_&&N(this.backoffId_),null!==this.pendingConnection_&&this.pendingConnection_.abort()}isRetryStatusCode_(e){const t=e>=500&&e<600,n=[408,429],r=-1!==n.indexOf(e),i=-1!==this.additionalRetryCodes_.indexOf(e);return t||r||i}}class q{constructor(e,t,n){this.wasSuccessCode=e,this.connection=t,this.canceled=!!n}}function $(e,t){null!==t&&t.length>0&&(e["Authorization"]="Firebase "+t)}function K(e,t){e["X-Firebase-Storage-Version"]="webjs/"+(null!==t&&void 0!==t?t:"AppManager")}function G(e,t){t&&(e["X-Firebase-GMPID"]=t)}function z(e,t){null!==t&&(e["X-Firebase-AppCheck"]=t)}function W(e,t,n,r,i,s){const o=U(e.urlParams),a=e.url+o,c=Object.assign({},e.headers);return G(c,t),$(c,n),K(c,s),z(c,r),new B(a,e.method,c,e.body,e.successCodes,e.additionalRetryCodes,e.handler,e.errorHandler,e.timeout,e.progressCallback,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function H(){return"undefined"!==typeof BlobBuilder?BlobBuilder:"undefined"!==typeof WebKitBlobBuilder?WebKitBlobBuilder:void 0}function Q(...e){const t=H();if(void 0!==t){const n=new t;for(let t=0;t<e.length;t++)n.append(e[t]);return n.getBlob()}if(M())return new Blob(e);throw new l("unsupported-environment","This browser doesn't seem to support creating Blobs")}function J(e,t,n){return e.webkitSlice?e.webkitSlice(t,n):e.mozSlice?e.mozSlice(t,n):e.slice?e.slice(t,n):null}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const X={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class Z{constructor(e,t){this.data=e,this.contentType=t||null}}function ee(e,t){switch(e){case X.RAW:return new Z(te(t));case X.BASE64:case X.BASE64URL:return new Z(re(e,t));case X.DATA_URL:return new Z(se(t),oe(t))}throw d()}function te(e){const t=[];for(let n=0;n<e.length;n++){let r=e.charCodeAt(n);if(r<=127)t.push(r);else if(r<=2047)t.push(192|r>>6,128|63&r);else if(55296===(64512&r)){const i=n<e.length-1&&56320===(64512&e.charCodeAt(n+1));if(i){const i=r,s=e.charCodeAt(++n);r=65536|(1023&i)<<10|1023&s,t.push(240|r>>18,128|r>>12&63,128|r>>6&63,128|63&r)}else t.push(239,191,189)}else 56320===(64512&r)?t.push(239,191,189):t.push(224|r>>12,128|r>>6&63,128|63&r)}return new Uint8Array(t)}function ne(e){let t;try{t=decodeURIComponent(e)}catch(n){throw k(X.DATA_URL,"Malformed data URL.")}return te(t)}function re(e,t){switch(e){case X.BASE64:{const n=-1!==t.indexOf("-"),r=-1!==t.indexOf("_");if(n||r){const t=n?"-":"_";throw k(e,"Invalid character '"+t+"' found: is it base64url encoded?")}break}case X.BASE64URL:{const n=-1!==t.indexOf("+"),r=-1!==t.indexOf("/");if(n||r){const t=n?"+":"/";throw k(e,"Invalid character '"+t+"' found: is it base64 encoded?")}t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=Y(t)}catch(i){throw k(e,"Invalid character found")}const r=new Uint8Array(n.length);for(let s=0;s<n.length;s++)r[s]=n.charCodeAt(s);return r}class ie{constructor(e){this.base64=!1,this.contentType=null;const t=e.match(/^data:([^,]+)?,/);if(null===t)throw k(X.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const n=t[1]||null;null!=n&&(this.base64=ae(n,";base64"),this.contentType=this.base64?n.substring(0,n.length-";base64".length):n),this.rest=e.substring(e.indexOf(",")+1)}}function se(e){const t=new ie(e);return t.base64?re(X.BASE64,t.rest):ne(t.rest)}function oe(e){const t=new ie(e);return t.contentType}function ae(e,t){const n=e.length>=t.length;return!!n&&e.substring(e.length-t.length)===t}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ce{constructor(e,t){let n=0,r="";L(e)?(this.data_=e,n=e.size,r=e.type):e instanceof ArrayBuffer?(t?this.data_=new Uint8Array(e):(this.data_=new Uint8Array(e.byteLength),this.data_.set(new Uint8Array(e))),n=this.data_.length):e instanceof Uint8Array&&(t?this.data_=e:(this.data_=new Uint8Array(e.length),this.data_.set(e)),n=e.length),this.size_=n,this.type_=r}size(){return this.size_}type(){return this.type_}slice(e,t){if(L(this.data_)){const n=this.data_,r=J(n,e,t);return null===r?null:new ce(r)}{const n=new Uint8Array(this.data_.buffer,e,t-e);return new ce(n,!0)}}static getBlob(...e){if(M()){const t=e.map((e=>e instanceof ce?e.data_:e));return new ce(Q.apply(null,t))}{const t=e.map((e=>P(e)?ee(X.RAW,e).data:e.data_));let n=0;t.forEach((e=>{n+=e.byteLength}));const r=new Uint8Array(n);let i=0;return t.forEach((e=>{for(let t=0;t<e.length;t++)r[i++]=e[t]})),new ce(r,!0)}}uploadData(){return this.data_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ue(e){let t;try{t=JSON.parse(e)}catch(n){return null}return O(t)?t:null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function le(e){if(0===e.length)return null;const t=e.lastIndexOf("/");if(-1===t)return"";const n=e.slice(0,t);return n}function he(e,t){const n=t.split("/").filter((e=>e.length>0)).join("/");return 0===e.length?n:e+"/"+n}function de(e){const t=e.lastIndexOf("/",e.length-2);return-1===t?e:e.slice(t+1)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fe(e,t){return t}class pe{constructor(e,t,n,r){this.server=e,this.local=t||e,this.writable=!!n,this.xform=r||fe}}let me=null;function ge(e){return!P(e)||e.length<2?e:de(e)}function ye(){if(me)return me;const e=[];function t(e,t){return ge(t)}e.push(new pe("bucket")),e.push(new pe("generation")),e.push(new pe("metageneration")),e.push(new pe("name","fullPath",!0));const n=new pe("name");function r(e,t){return void 0!==t?Number(t):t}n.xform=t,e.push(n);const i=new pe("size");return i.xform=r,e.push(i),e.push(new pe("timeCreated")),e.push(new pe("updated")),e.push(new pe("md5Hash",null,!0)),e.push(new pe("cacheControl",null,!0)),e.push(new pe("contentDisposition",null,!0)),e.push(new pe("contentEncoding",null,!0)),e.push(new pe("contentLanguage",null,!0)),e.push(new pe("contentType",null,!0)),e.push(new pe("metadata","customMetadata",!0)),me=e,me}function ve(e,t){function n(){const n=e["bucket"],r=e["fullPath"],i=new C(n,r);return t._makeStorageReference(i)}Object.defineProperty(e,"ref",{get:n})}function we(e,t,n){const r={type:"file"},i=n.length;for(let s=0;s<i;s++){const e=n[s];r[e.local]=e.xform(r,t[e.server])}return ve(r,e),r}function _e(e,t,n){const r=ue(t);if(null===r)return null;const i=r;return we(e,i,n)}function be(e,t){const n={},r=t.length;for(let i=0;i<r;i++){const r=t[i];r.writable&&(n[r.server]=e[r.local])}return JSON.stringify(n)}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ee(e){if(!e)throw d()}function Te(e,t){function n(n,r){const i=_e(e,r,t);return Ee(null!==i),i}return n}function Se(e){function t(t,n){let r;return r=401===t.getStatus()?t.getErrorText().includes("Firebase App Check token is invalid")?m():p():402===t.getStatus()?f(e.bucket):403===t.getStatus()?g(e.path):n,r.serverResponse=n.serverResponse,r}return t}function ke(e,t){return e&&e["contentType"]||t&&t.type()||"application/octet-stream"}function Ae(e,t,n){const r=Object.assign({},n);return r["fullPath"]=e.path,r["size"]=t.size(),r["contentType"]||(r["contentType"]=ke(null,t)),r}function Ce(e,t,n,r,i){const s=t.bucketOnlyServerUrl(),o={"X-Goog-Upload-Protocol":"multipart"};function a(){let e="";for(let t=0;t<2;t++)e+=Math.random().toString().slice(2);return e}const c=a();o["Content-Type"]="multipart/related; boundary="+c;const u=Ae(t,r,i),l=be(u,n),h="--"+c+"\r\nContent-Type: application/json; charset=utf-8\r\n\r\n"+l+"\r\n--"+c+"\r\nContent-Type: "+u["contentType"]+"\r\n\r\n",d="\r\n--"+c+"--",f=ce.getBlob(h,r,d);if(null===f)throw I();const p={name:u["fullPath"]},m=V(s,e.host,e._protocol),g="POST",y=e.maxUploadRetryTime,v=new Ie(m,g,Te(e,n),y);return v.urlParams=p,v.headers=o,v.body=f.uploadData(),v.errorHandler=Se(t),v}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
let xe=null;class Re{constructor(){this.sent_=!1,this.xhr_=new XMLHttpRequest,this.initXhr(),this.errorCode_=j.NO_ERROR,this.sendPromise_=new Promise((e=>{this.xhr_.addEventListener("abort",(()=>{this.errorCode_=j.ABORT,e()})),this.xhr_.addEventListener("error",(()=>{this.errorCode_=j.NETWORK_ERROR,e()})),this.xhr_.addEventListener("load",(()=>{e()}))}))}send(e,t,n,r){if(this.sent_)throw A("cannot .send() more than once");if(this.sent_=!0,this.xhr_.open(t,e,!0),void 0!==r)for(const i in r)r.hasOwnProperty(i)&&this.xhr_.setRequestHeader(i,r[i].toString());return void 0!==n?this.xhr_.send(n):this.xhr_.send(),this.sendPromise_}getErrorCode(){if(!this.sent_)throw A("cannot .getErrorCode() before sending");return this.errorCode_}getStatus(){if(!this.sent_)throw A("cannot .getStatus() before sending");try{return this.xhr_.status}catch(e){return-1}}getResponse(){if(!this.sent_)throw A("cannot .getResponse() before sending");return this.xhr_.response}getErrorText(){if(!this.sent_)throw A("cannot .getErrorText() before sending");return this.xhr_.statusText}abort(){this.xhr_.abort()}getResponseHeader(e){return this.xhr_.getResponseHeader(e)}addUploadProgressListener(e){null!=this.xhr_.upload&&this.xhr_.upload.addEventListener("progress",e)}removeUploadProgressListener(e){null!=this.xhr_.upload&&this.xhr_.upload.removeEventListener("progress",e)}}class Ne extends Re{initXhr(){this.xhr_.responseType="text"}}function De(){return xe?xe():new Ne}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class Oe{constructor(e,t){this._service=e,this._location=t instanceof C?t:C.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new Oe(e,t)}get root(){const e=new C(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return de(this._location.path)}get storage(){return this._service}get parent(){const e=le(this._location.path);if(null===e)return null;const t=new C(this._location.bucket,e);return new Oe(this._service,t)}_throwIfRoot(e){if(""===this._location.path)throw S(e)}}function Pe(e,t,n){e._throwIfRoot("uploadBytes");const r=Ce(e.storage,e._location,ye(),new ce(t,!0),n);return e.storage.makeRequestWithTokens(r,De).then((t=>({metadata:t,ref:e})))}function Le(e,t,n=X.RAW,r){e._throwIfRoot("uploadString");const i=ee(n,t),s=Object.assign({},r);return null==s["contentType"]&&null!=i.contentType&&(s["contentType"]=i.contentType),Pe(e,i.data,s)}function Me(e,t){const n=he(e._location.path,t),r=new C(e._location.bucket,n);return new Oe(e.storage,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fe(e){return/^[A-Za-z]+:\/\//.test(e)}function Ve(e,t){return new Oe(e,t)}function Ue(e,t){if(e instanceof qe){const n=e;if(null==n._bucket)throw b();const r=new Oe(n,n._bucket);return null!=t?Ue(r,t):r}return void 0!==t?Me(e,t):e}function je(e,t){if(t&&Fe(t)){if(e instanceof qe)return Ve(e,t);throw E("To use ref(service, url), the first argument must be a Storage instance.")}return Ue(e,t)}function Be(e,t){const n=null===t||void 0===t?void 0:t[a];return null==n?null:C.makeFromBucketSpec(n,e)}class qe{constructor(e,t,n,r,i){this.app=e,this._authProvider=t,this._appCheckProvider=n,this._url=r,this._firebaseVersion=i,this._bucket=null,this._host=o,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=c,this._maxUploadRetryTime=u,this._requests=new Set,this._bucket=null!=r?C.makeFromBucketSpec(r,this._host):Be(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,null!=this._url?this._bucket=C.makeFromBucketSpec(this._url,e):this._bucket=Be(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){F("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){F("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const t=await e.getToken();if(null!==t)return t.accessToken}return null}async _getAppCheckToken(){const e=this._appCheckProvider.getImmediate({optional:!0});if(e){const t=await e.getToken();return t.token}return null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach((e=>e.cancel())),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new Oe(this,e)}_makeRequest(e,t,n,r){if(this._deleted)return new x(T());{const i=W(e,this._appId,n,r,t,this._firebaseVersion);return this._requests.add(i),i.getPromise().then((()=>this._requests.delete(i)),(()=>this._requests.delete(i))),i}}async makeRequestWithTokens(e,t){const[n,r]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,t,n,r).getPromise()}}const $e="@firebase/storage",Ke="0.9.5",Ge="storage";function ze(e,t,n,r){return e=(0,i.m9)(e),Le(e,t,n,r)}function We(e,t){return e=(0,i.m9)(e),je(e,t)}function He(e=(0,r.getApp)(),t){e=(0,i.m9)(e);const n=(0,r._getProvider)(e,Ge),s=n.getImmediate({identifier:t});return s}function Qe(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return new qe(n,i,s,t,r.SDK_VERSION)}function Je(){(0,r._registerComponent)(new s.wA(Ge,Qe,"PUBLIC").setMultipleInstances(!0)),(0,r.registerVersion)($e,Ke,""),(0,r.registerVersion)($e,Ke,"esm2017")}Je()},223:function(e,t,n){"use strict";n.d(t,{BH:function(){return h},G6:function(){return I},L:function(){return a},LL:function(){return A},Mn:function(){return b},Sg:function(){return d},X3:function(){return W},ZB:function(){return u},ZR:function(){return k},b$:function(){return v},d:function(){return w},eu:function(){return T},hl:function(){return E},jU:function(){return g},m9:function(){return B},ne:function(){return F},pd:function(){return M},r3:function(){return R},ru:function(){return y},tV:function(){return c},uI:function(){return p},vZ:function(){return D},w1:function(){return _},xO:function(){return P},xb:function(){return N},z$:function(){return f},zd:function(){return L}});n(1703),n(2801);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Re(e,t){return V(e,"POST","/v1/accounts:signInWithPassword",L(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Ne(e,t){return V(e,"POST","/v1/accounts:signInWithEmailLink",L(e,t))}async function De(e,t){return V(e,"POST","/v1/accounts:signInWithEmailLink",L(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Je extends He{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return Me._fromParams({providerId:Je.PROVIDER_ID,signInMethod:Je.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return Je.credentialFromTaggedObject(e)}static credentialFromError(e){return Je.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:n}=e;if(!t&&!n)return null;try{return Je.credential(t,n)}catch(r){return null}}}Je.GOOGLE_SIGN_IN_METHOD="google.com",Je.PROVIDER_ID="google.com";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cn=new R(3e4,6e4);function xn(){const e=kt().___jsl;if(null===e||void 0===e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let n=0;n<e.CP.length;n++)e.CP[n]=null}function Rn(e){return new Promise(((t,n)=>{var r,i,s;function o(){xn(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{xn(),n(p(e,"network-request-failed"))},timeout:Cn.get()})}if(null===(i=null===(r=kt().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=kt().gapi)||void 0===s?void 0:s.load)){const t=Yt("iframefcb");return kt()[t]=()=>{gapi.load?o():n(p(e,"network-request-failed"))},Jt(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw Nn=null,e}))}let Nn=null;function Dn(e){return Nn=Nn||Rn(e),Nn}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mf=-1;class Ff extends Ef{constructor(e,t,n){super(e,t,n),this.type="firestore",this._queue=new Of,this._persistenceKey="name"in e?e.name:"[DEFAULT]"}_terminate(){return this._firestoreClient||Uf(this),this._firestoreClient.terminate()}}function Vf(e){return e._firestoreClient||Uf(e),e._firestoreClient.verifyNotTerminated(),e._firestoreClient}function Uf(e){var t;const n=e._freezeSettings(),r=function(e,t,n,r){return new Mi(e,t,n,r.host,r.ssl,r.experimentalForceLongPolling,r.experimentalAutoDetectLongPolling,r.useFetchStreams)}(e._databaseId,(null===(t=e._app)||void 0===t?void 0:t.options.appId)||"",e._persistenceKey,n);e._firestoreClient=new Wd(e._authCredentials,e._appCheckCredentials,e._queue,r)}function jf(e,t){Qf(e=_f(e,Ff));const n=Vf(e),r=e._freezeSettings(),i=new Bd;return qf(n,i,new Ud(i,r.cacheSizeBytes,null==t?void 0:t.forceOwnership))}function Bf(e){Qf(e=_f(e,Ff));const t=Vf(e),n=e._freezeSettings(),r=new Bd;return qf(t,r,new jd(r,n.cacheSizeBytes))}function qf(e,t,n){const r=new ni;return e.asyncQueue.enqueue((async()=>{try{await Hd(e,n),await Qd(e,t),r.resolve()}catch(e){if(!function(e){return"FirebaseError"===e.name?e.code===ei.FAILED_PRECONDITION||e.code===ei.UNIMPLEMENTED:!("undefined"!=typeof DOMException&&e instanceof DOMException)||(22===e.code||20===e.code||11===e.code)}(e))throw e;console.warn("Error enabling offline persistence. Falling back to persistence disabled: "+e),r.reject(e)}})).then((()=>r.promise))}function $f(e){if(e._initialized&&!e._terminated)throw new ti(ei.FAILED_PRECONDITION,"Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");const t=new ni;return e._queue.enqueueAndForgetEvenWhileRestricted((async()=>{try{await async function(e){if(!Rc.vt())return Promise.resolve();const t=e+"main";await Rc.delete(t)}(al(e._databaseId,e._persistenceKey)),t.resolve()}catch(e){t.reject(e)}})),t.promise}function Kf(e){return function(e){const t=new ni;return e.asyncQueue.enqueueAndForget((async()=>md(await tf(e),t))),t.promise}(Vf(e=_f(e,Ff)))}function Gf(e){return rf(Vf(e=_f(e,Ff)))}function zf(e){return sf(Vf(e=_f(e,Ff)))}function Wf(e,t){const n=Vf(e=_f(e,Ff)),r=new Lf;return df(n,e._databaseId,t,r),r}function Hf(e,t){return ff(Vf(e=_f(e,Ff)),t).then((t=>t?new kf(e,null,t.query):null))}function Qf(e){if(e._initialized||e._terminated)throw new ti(ei.FAILED_PRECONDITION,"Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function om(e){e=_f(e,Sf);const t=_f(e.firestore,Ff);return af(Vf(t),e._key).then((n=>_m(t,e,n)))}class am extends tm{constructor(e){super(),this.firestore=e}convertBytes(e){return new Yf(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Sf(this.firestore,null,t)}}function cm(e){e=_f(e,Sf);const t=_f(e.firestore,Ff),n=Vf(t),r=new am(t);return of(n,e._key).then((n=>new Rp(t,r,e._key,n,new xp(null!==n&&n.hasLocalMutations,!0),e.converter)))}function um(e){e=_f(e,Sf);const t=_f(e.firestore,Ff);return af(Vf(t),e._key,{source:"server"}).then((n=>_m(t,e,n)))}function lm(e){e=_f(e,kf);const t=_f(e.firestore,Ff),n=Vf(t),r=new am(t);return Lp(e._query),uf(n,e._query).then((n=>new Dp(t,r,e,n)))}function hm(e){e=_f(e,kf);const t=_f(e.firestore,Ff),n=Vf(t),r=new am(t);return cf(n,e._query).then((n=>new Dp(t,r,e,n)))}function dm(e){e=_f(e,kf);const t=_f(e.firestore,Ff),n=Vf(t),r=new am(t);return uf(n,e._query,{source:"server"}).then((n=>new Dp(t,r,e,n)))}function fm(e,t,n){e=_f(e,Sf);const r=_f(e.firestore,Ff),i=nm(e.converter,t,n);return wm(r,[ap(op(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,Ao.none())])}function pm(e,t,n,...r){e=_f(e,Sf);const i=_f(e.firestore,Ff),s=op(i);let o;return o="string"==typeof(t=(0,c.m9)(t))||t instanceof Jf?mp(s,"updateDoc",e._key,t,n,r):pp(s,"updateDoc",e._key,t),wm(i,[o.toMutation(e._key,Ao.exists(!0))])}function mm(e){return wm(_f(e.firestore,Ff),[new jo(e._key,Ao.none())])}function gm(e,t){const n=_f(e.firestore,Ff),r=Rf(e),i=nm(e.converter,t);return wm(n,[ap(op(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,Ao.exists(!1))]).then((()=>r))}function ym(e,...t){var n,r,i;e=(0,c.m9)(e);let s={includeMetadataChanges:!1},o=0;"object"!=typeof t[o]||Pf(t[o])||(s=t[o],o++);const a={includeMetadataChanges:s.includeMetadataChanges};if(Pf(t[o])){const e=t[o];t[o]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[o+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[o+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}let u,l,h;if(e instanceof Sf)l=_f(e.firestore,Ff),h=zs(e._key.path),u={next:n=>{t[o]&&t[o](_m(l,e,n))},error:t[o+1],complete:t[o+2]};else{const n=_f(e,kf);l=_f(n.firestore,Ff),h=n._query;const r=new am(l);u={next:e=>{t[o]&&t[o](new Dp(l,r,n,e))},error:t[o+1],complete:t[o+2]},Lp(e._query)}return function(e,t,n,r){const i=new $d(r),s=new Qh(t,i,n);return e.asyncQueue.enqueueAndForget((async()=>Kh(await nf(e),s))),()=>{i.Ia(),e.asyncQueue.enqueueAndForget((async()=>Gh(await nf(e),s)))}}(Vf(l),h,a,u)}function vm(e,t){return lf(Vf(e=_f(e,Ff)),Pf(t)?t:{next:t})}function wm(e,t){return function(e,t){const n=new ni;return e.asyncQueue.enqueueAndForget((async()=>ud(await tf(e),t,n))),n.promise}(Vf(e),t)}function _m(e,t,n){const r=n.docs.get(t._key),i=new am(e);return new Rp(e,i,t._key,r,new xp(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ng={Firestore:Fm,GeoPoint:Zf,Timestamp:yi,Blob:Om,Transaction:jm,WriteBatch:Bm,DocumentReference:$m,DocumentSnapshot:Wm,Query:Qm,QueryDocumentSnapshot:Hm,QuerySnapshot:Ym,CollectionReference:Xm,FieldPath:eg,FieldValue:tg,setLogLevel:Um,CACHE_SIZE_UNLIMITED:Mf};function rg(e,t){e.INTERNAL.registerComponent(new o.wA("firestore-compat",(e=>{const n=e.getProvider("app-compat").getImmediate(),r=e.getProvider("firestore").getImmediate();return t(n,r)}),"PUBLIC").setServiceProps(Object.assign({},ng)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */if((0,r.jU)()&&void 0!==self.firebase){f.warn("\n    Warning: Firebase is already defined in the global scope. Please make sure\n    Firebase library is only loaded once.\n  ");const e=self.firebase.SDK_VERSION;e&&e.indexOf("LITE")>=0&&f.warn("\n    Warning: You are trying to load Firebase while using Firebase Performance standalone script.\n    You should load Firebase Performance with this instance of Firebase to avoid loading duplicate code.\n    ")}const y=d;g()},9684:function(e,t,n){"use strict";n.r(t),n.d(t,{FirebaseError:function(){return s.ZR},SDK_VERSION:function(){return Q},_DEFAULT_ENTRY_NAME:function(){return M},_addComponent:function(){return j},_addOrOverwriteComponent:function(){return B},_apps:function(){return V},_clearComponents:function(){return G},_components:function(){return U},_getProvider:function(){return $},_registerComponent:function(){return q},_removeServiceInstance:function(){return K},deleteApp:function(){return Z},getApp:function(){return Y},getApps:function(){return X},initializeApp:function(){return J},onLog:function(){return te},registerVersion:function(){return ee},setLogLevel:function(){return ne}});var r=n(7142),i=n(5168),s=n(223);
/**
 * @license
 * Copyright 2019 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.df968d50.js.map